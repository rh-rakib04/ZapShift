...
const HowItWork = () => {
  return (
    <div className="w-10/12 mx-auto my-10">
      <h1 className="text-3xl md:text-4xl font-bold my-5">How it Works</h1>

      <div className=" grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-10">
        <div className=" text-secondary bg-[#EAECED] p-3 md:p-7 rounded-2xl flex flex-col gap-2 hover:shadow-2xl">
